...
import com.FoodBoxs.android.adapter.IngredientCustomAdapter;
...
import com.FoodBoxs.android.utils.TopAlignSuperscriptSpan;
        ...
        ib_minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itemQuantity > 1) {
                    ...
                    Toast.makeText(DetailPage.this, "Item Quantity to be atleast 1!", Toast.LENGTH_SHORT).show();
            }
        });
