        ...
        switch (position) {
            case 0:
                if (timeLineModel.getStatus().equals(OrderStatus.ACTIVE)) {
                    ...
                    layer2 = mContext.getResources().getDrawable(R.drawable.orderstatus1);
                    holder.mTimelineView.setEndLine(mContext.getResources().getColor(R.color.colorBlue), getItemViewType(position));
                }
                break;
            case 1:
                if (timeLineModel.getStatus().equals(OrderStatus.ACTIVE)) {
                    layer1.setColor(mContext.getResources().getColor(R.color.colorBlue));
                    layer2 = mContext.getResources().getDrawable(R.drawable.orderstatus2);
                    holder.mTimelineView.setStartLine(mContext.getResources().getColor(R.color.colorBlue), getItemViewType(position));
                    holder.mTimelineView.setEndLine(mContext.getResources().getColor(R.color.colorBlue), getItemViewType(position));
                }
                break;
            case 2:
